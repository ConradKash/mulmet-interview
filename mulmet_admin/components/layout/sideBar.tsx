...
const sidebarLinks = [
  ...
  { href: "/tasks", label: "Taskss", icon: <FaTasks /> },
];
...
const SideBar: React.FC = () => {
  return (
    <aside className="w-60 h-screen bg-[#1A2236] text-white flex flex-col justify-between fixed left-0 top-0 shadow-lg z-[100]">
      ...
      <div className="p-6">
        <button className="w-full bg-[#FF6B6B] text-white border-none rounded-md py-3 font-semibold text-base flex items-center justify-center gap-2 cursor-pointer transition-colors duration-200 hover:bg-[#ff5252]">
          <FaSignOutAlt />
          Logout
        </button>
      </div>
